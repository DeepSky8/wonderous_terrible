...
const civilHeader = {
    1: 'What is your species like biologically?',
    2: 'What is their society like?',
    3: 'What is your premier ship like?',
    4: "What is your premier ship's crew like?"

}

const civilBio = {
    header: 'If the group as a whole agrees that the Civilization they wish to play is human, move on to the next step.',
    step1: `Starting to the right of the GM, have each player define one biological trait about your Civilization's species.`,
...
export { civilHeader, civilBio, civilSociety, civilShip, civilCrew }